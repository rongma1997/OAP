...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(std::make_tuple(10, 100), std::make_tuple(100, 100),
                      std::make_tuple(500, 100), std::make_tuple(1000, 100),
                      std::make_tuple(10, 500), std::make_tuple(100, 500),
                      std::make_tuple(500, 500), std::make_tuple(1000, 500),
                      std::make_tuple(10, 1000), std::make_tuple(100, 1000),
                      std::make_tuple(500, 1000), std::make_tuple(1000, 1000)
                      ));
